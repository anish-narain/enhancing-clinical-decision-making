...
def train(x_size, c_size, c_dimension, y_dimension, x_to_c_learning_rate, c_to_y_learning_rate, epochs, train_loader):
    ...
    ground_truth_c = []
    ground_truth_y = []
    x_to_c_accuracy_values = []
    c_to_y_accuracy_values = []
    ...
    return x_to_c, c_to_y, x_to_c_loss_values, c_to_y_loss_values, x_to_c_predictions, c_to_y_predictions, epochs_count, ground_truth_c, ground_truth_y, x_to_c_accuracy_values, c_to_y_accuracy_values
...
def main():
    ...
    # Run the training
    x_to_c, c_to_y, x_to_c_loss_values, c_to_y_loss_values, x_to_c_predictions, c_to_y_predictions, epochs_count, ground_truth_c, ground_truth_y, x_to_c_accuracy_values, c_to_y_accuracy_values = train(
