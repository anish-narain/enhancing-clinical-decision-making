...
if __name__ == "__main__":
    main(
        ...
        chunk_size=4096,
        chunk_overlap=100,
        output_csv_file='cardiac_arrest-trial.csv',  # Change the output file name to a CSV file
        progress_report_file='cardiac_arrest-trial.txt',  # Path to the progress report file
        num_patients = 15
    )
